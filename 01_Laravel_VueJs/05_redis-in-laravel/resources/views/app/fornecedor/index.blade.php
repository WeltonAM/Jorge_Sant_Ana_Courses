                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <a title="Editar" class="btn btn-sm w-50" href="{{ route('fornecedores.edit', ['id' => $fornecedor->id]) }}">
                                    ...
                                    <button title="Deletar" class="btn btn-sm w-50" style="background-color: transparent; color: #000; border-color: transparent;" onclick="openConfirmModal('{{ $fornecedor->id }}')">
...
@include('components.modalExclusao', [
    ...
    'modalMessage' => 'Tem certeza que deseja excluir este fornecedor?',
...
<script>
    function openConfirmModal(fornecedorId) {
        console.log(fornecedorId);
        var deleteUrl = `fornecedores/delete/${fornecedorId}`;
