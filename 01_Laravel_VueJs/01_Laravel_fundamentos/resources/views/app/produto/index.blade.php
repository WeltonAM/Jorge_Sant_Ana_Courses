                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <a class="btn btn-sm w-50" href="{{ route('produto-detalhe.index', ['id' => $produto->id]) }}">
                                    ...
                                    <a class="btn btn-sm w-50" href="{{ route('produtos.edit', ['id' => $produto->id]) }}">
                                    ...
                                    <button class="btn btn-sm w-50" style="background-color: transparent; color: #000; border-color: transparent;" onclick="openConfirmModal('{{ $produto->id }}')">
