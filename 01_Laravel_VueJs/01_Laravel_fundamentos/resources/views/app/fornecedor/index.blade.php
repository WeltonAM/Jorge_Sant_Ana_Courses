                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <a class="btn btn-sm w-50" href="{{ route('fornecedores.edit', ['id' => $fornecedor->id]) }}">
                                    ...
                                    <button class="btn btn-sm w-50" style="background-color: transparent; color: #000; border-color: transparent;" onclick="openConfirmModal('{{ $fornecedor->id }}')">
